...
const SideBar = async () => {
	...
	return (
		<section className="sticky left-0 top-0  background-light900_dark200 light-border h-screen flex flex-col justify-between overflow-y-auto border-r p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]">
