...
export const PaginationedSerachParamsSchema = z.object({
...
export const GetAnswersSchema = PaginationedSerachParamsSchema.extend({
	questionId: z.string().min(1, { message: "Question ID is required." }),
});
...
export const AIAnswerSchema = z.object({
	...
	content: z.string().min(1, { message: "Please Provide Some content" }),
	userAnswer: z.string().optional(),
});
export const CreateVoteSchema = z.object({
	targetId: z.string().min(1, { message: "Target ID is required." }),
	targetType: z.enum(["question", "answer"], { message: "Ibvalid target type" }),
...
export const GetUserQuestionsSchema = PaginationedSerachParamsSchema.extend({
	userId: z.string().min(1, { message: "User ID is required." }),
});
export const GetUsersAnswersSchema = PaginationedSerachParamsSchema.extend({
	userId: z.string().min(1, { message: "User ID is required." }),
});
...
export const CreateInteractionSchema = z.object({
	...
	actionTarget: z.enum(["question", "answer"], { message: "Invalid action target." }),
